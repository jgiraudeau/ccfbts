                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
                            Gestion des Classes
                            <span className="text-[10px] bg-yellow-400 text-black px-2 py-0.5 rounded-full animate-bounce">MISE À JOUR ✅</span>
                        </h1>
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={syncClasses}
                            disabled={syncing}
                            className={`flex items-center gap-2 px-6 py-3 rounded-lg transition-all bg-amber-100 border-2 border-amber-500 text-amber-800 hover:bg-amber-200 font-bold shadow-md ${syncing ? 'opacity-50' : ''}`}
                            title="Créer les classes automatiquement à partir des noms des élèves"
                        >
                            <Users size={20} className={syncing ? 'animate-pulse' : ''} />
                            {syncing ? 'Synchronisation...' : 'SYNCHRONISER LES ÉLÈVES'}
                        </button>
                        <button
